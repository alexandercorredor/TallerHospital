...
const mostrarPacientes = function () {
  ...
  // Recorrer array pacientes con for of
...
//Unicamente ejecuta el addEventListener cuando estamos ubicados en registro-pacientes.html
if (window.location.href.endsWith("registro-pacientes.html")) {
  ...
  formularioPacientes.addEventListener("submit", function (event) {
    ...
    // Guardar info de pacientes en localStorage
